  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'lambda/account': path.resolve(__dirname, 'lambda/account.ts'),
        'lambda/admin': path.resolve(__dirname, 'lambda/admin.ts'),
        'lambda/corsProxy': path.resolve(__dirname, 'lambda/corsProxy.ts'),
        'lambda/gocardless': path.resolve(__dirname, 'lambda/gocardless.ts'),
        'lambda/health': path.resolve(__dirname, 'lambda/health.ts'),
        'lambda/info': path.resolve(__dirname, 'lambda/info.ts'),
        'lambda/metrics': path.resolve(__dirname, 'lambda/metrics.ts'),
        'lambda/migrate': path.resolve(__dirname, 'lambda/migrate.ts'),
        'lambda/mode': path.resolve(__dirname, 'lambda/mode.ts'),
        'lambda/openid': path.resolve(__dirname, 'lambda/openid.ts'),
        'lambda/pluggyai': path.resolve(__dirname, 'lambda/pluggyai.ts'),
        'lambda/secret': path.resolve(__dirname, 'lambda/secret.ts'),
        'lambda/simplefin': path.resolve(__dirname, 'lambda/simplefin.ts'),
        'lambda/sync': path.resolve(__dirname, 'lambda/sync.ts'),
